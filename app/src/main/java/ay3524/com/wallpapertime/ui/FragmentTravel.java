...
public class FragmentTravel extends Fragment implements WallpaperAdapter.ListItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            adapter = new WallpaperAdapter(wallpapersList, FragmentTravel.this);
    ...
    private void getListOfWallpapers() {
        ...
        Call<WallpaperResponse> call = apiService.getWallpaper(Constants.api_key,
                Constants.response_group,Constants.travel,Constants.booleanImagesWithEditorsCoice,
