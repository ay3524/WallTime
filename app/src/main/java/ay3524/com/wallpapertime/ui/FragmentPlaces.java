...
public class FragmentPlaces extends Fragment implements WallpaperAdapter.ListItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            adapter = new WallpaperAdapter(wallpapersList, FragmentPlaces.this);
    ...
    private void getListOfWallpapers() {
        ...
        Call<WallpaperResponse> call = apiService.getWallpaper(Constants.api_key,
                Constants.response_group,Constants.places, Constants.booleanImagesWithEditorsCoice,
